...
class CmisTypeCache {
  ...
  Map _types = new Map<String,jsonobject.JsonObject>(); 
   ...
   */
  jsonobject.JsonObject getType(String typeId) {
  ...
  void removeOldestElement() {
   ...
   /* Find the oldest entry */
    _lastAccessed.forEach((String key, DateTime value){
   ...
   */
  void addType( jsonobject.JsonObject typeDef) {
